...
public class Signup extends JFrame {
    ...
    Signup(){
        ...
        JLabel labelques = new JLabel ("Security Question:");
        labelques.setFont(new Font("Raleway",Font.BOLD,25));
        labelques.setBounds(100,440,400,30);
        add(labelques);
        JLabel labelselect = new JLabel ("select a question:");
        labelselect.setFont(new Font("Raleway",Font.BOLD,19));
        labelselect.setBounds(150,470,400,30);
        add(labelselect);

        String[] questions = {"Your pet name?", "Your first school?", "Your nickname?"};
//        Font font = new Font("Raleway",Font.BOLD,19); // Adjust font size here
//        questions.setFont(font);
        secques =new JComboBox<>(questions);
        secques.setFont(new Font("Raleway", Font.BOLD, 25));
        secques.setBounds(360,470,300,30);
        add(secques);
